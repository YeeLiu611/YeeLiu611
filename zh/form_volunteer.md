...
<form class="form" name="volunteer-application" method="POST" data-netlify="true" action="/zh/ThankYou">
  ...
  <h3>你的第二语言</h3>
  <label>语言：<input type="text" name="second_language"></label><br>
  <fieldset>
    <legend>水平（单选）：</legend>
    ...
    <label><input type="radio" name="language_proficiency" value="能在第一语言和第二语言之间进行准确流畅的互译"> 能在第一语言和第二语言之间进行准确流畅的互译</label><br>
  </fieldset>
