...
<form class="form" name="volunteer-application" method="POST" data-netlify="true" action="en/ThankYou">
  ...
  <fieldset>
    ...
    <label><input type="radio" name="language_proficiency" value="Able to engage in complex and in-depth conversations and emails"> Able to engage in complex and in-depth conversations and emails</label><br>
    <label><input type="radio" name="language_proficiency" value="Able to accurately and fluently interpret between the first and second language"> Able to accurately and fluently interpret between the first and second language</label><br>
  </fieldset>
